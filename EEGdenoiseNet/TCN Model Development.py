...
class TCN_Denoiser(nn.Module):
    def __init__(self, input_channels=1, output_channels=1, num_channels=[32, 64, 64, 32], kernel_size=3, dropout=0.2):
        super(TCN_Denoiser, self).__init__()
